...
export const PROMO_BANNERS: PromoBanner[] = [
  ...
  },
  {
    ...
    title: "Phonics and sight-word readers that build confidence",
    body: "Level-by-level readers, sight words and fluency sentences for early readers.",
    ctaLabel: "Shop phonics",
    search: { category: "Phonics & Sight Words" },
    tone: "primary",
  ...
  },
  {
    ...
    ctaLabel: "Shop activity books",
    search: { category: "Activity Books" },
    tone: "leaf",
    badge: "GST invoicing",
  },
];
